...
from backend.cli.openapi import (
    build_typed_error_response_schema,
    extract_query_parameters,
    humanize_class_name,
    response_description,
    schema_has_status_property,
    schema_is_empty,
    strip_auto_titles,
)
...
class TestSchemaHasStatusProperty:
    """Tests for schema_has_status_property helper."""

    def test_direct_status_returns_true(self) -> None:
        """
        GIVEN a schema with a direct 'status' field
        WHEN schema_has_status_property is called
        THEN it returns True
        """
        assert schema_has_status_property(DirectStatusSchema)
    ...
    def test_inherited_status_returns_true(self) -> None:
        ...
        THEN it returns True
        """
        assert schema_has_status_property(InheritedStatusSchema)
    ...
    def test_no_status_returns_false(self) -> None:
        ...
        """
        assert not schema_has_status_property(NoStatusSchema)


class TestSchemaIsEmpty:
    """Tests for schema_is_empty helper."""

    def test_empty_schema_returns_true(self) -> None:
        """
        GIVEN a schema with no fields
        WHEN schema_is_empty is called
        THEN it returns True
        """
        assert schema_is_empty(EmptySchema)
    ...
    def test_non_empty_schema_returns_false(self) -> None:
        ...
        THEN it returns False
        """
        assert not schema_is_empty(NonEmptySchema)
...
class TestHumanizeClassName:
    ...
    def test_strips_schema_suffix(self) -> None:
        ...
        """
        assert humanize_class_name("UtubSummarySchema") == "UTub summary"
    ...
    def test_strips_bare_response_suffix(self) -> None:
        ...
        """
        assert humanize_class_name("UtubSummaryResponse") == "UTub summary"
    ...
    def test_acronym_map_applied_mid_name(self) -> None:
        ...
        """
        assert humanize_class_name("UrlValidationSchema") == "URL validation"
    ...
    def test_api_acronym_applied(self) -> None:
        ...
        """
        assert humanize_class_name("ApiKeySchema") == "API key"
    ...
    def test_id_acronym_applied(self) -> None:
        ...
        """
        assert humanize_class_name("UserIdSchema") == "User ID"
    ...
    def test_single_word_no_suffix(self) -> None:
        ...
        """
        assert humanize_class_name("Summary") == "Summary"
    ...
    def test_first_token_capitalized_rest_lowercased(self) -> None:
        ...
        """
        assert humanize_class_name("MemberListResponseSchema") == "Member list"


class TestResponseDescription:
    """Tests for response_description helper."""

    def test_error_status_returns_http_phrase(self) -> None:
        """
        GIVEN a status code >= 400 that is in HTTP_STATUS_DESCRIPTIONS
        WHEN response_description is called
        THEN the HTTP phrase is returned
        """
        result = response_description(400, NonEmptySchema)
    ...
    def test_unmapped_error_status_returns_error(self) -> None:
        ...
        """
        result = response_description(418, NonEmptySchema)
        assert result == "Error"
    ...
    def test_success_with_docstring_returns_docstring(self) -> None:
        ...
        """
        result = response_description(200, SchemaWithDocstring)
    ...
    def test_success_without_docstring_delegates_to_humanize(self) -> None:
        ...
        WHEN response_description is called
        THEN it delegates to humanize_class_name
        """
        result = response_description(200, SchemaWithoutDocstring)
        assert result == "Schema without docstring"


class TestStripAutoTitles:
    """Tests for strip_auto_titles helper."""
    ...
    def test_strip_auto_titles_removes_property_titles(self) -> None:
        ...
        WHEN strip_auto_titles is called
...
class _TestErrorCodes(IntEnum):
    """Test error codes for build_typed_error_response_schema tests."""
...
class TestBuildTypedErrorResponseSchema:
    ...
    def test_returns_name_and_allof_structure(self) -> None:
        ...
        schema_name = build_typed_error_response_schema(
    ...
    def test_first_write_wins_preserves_existing_entry(self) -> None:
        ...
        WHEN build_typed_error_response_schema is called a second time
        THEN the existing entry is not overwritten
        """
        components_schemas: dict[str, object] = {}
        first_name = build_typed_error_response_schema(
            _TestErrorCodes, components_schemas
        )
        ...
        second_name = build_typed_error_response_schema(
            _TestErrorCodes, components_schemas
        )
...
class TestExtractQueryParameters:
    """Tests for `extract_query_parameters` — the helper that turns a Pydantic
    ...
    def test_explode_marked_array_emits_comma_delimited_serialization(self) -> None:
        ...
        """
        params = extract_query_parameters(_ArrayQueryParamProbeSchema, {})
