"""Unit tests for the sanitize_and_reject_if_modified validator."""

import pytest

from backend.schemas.requests._sanitize import (
    INVALID_INPUT,
    sanitize_and_reject_if_modified,
)
