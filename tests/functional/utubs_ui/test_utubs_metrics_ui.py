...
def test_utub_select_emits_to_anonymous_metrics(
    ...
    wait_then_click_element(page=page, css_selector=utub_selector_css)
...
def test_utub_create_form_submit_emits_to_anonymous_metrics(
    ...
    create_utub(
        ...
        utub_description=_TEST_UTUB_DESCRIPTION,
    )
    ...
    created_utub_tile = wait_then_get_element(
        page=page,
        css_selector=f"{HPL.SELECTORS_UTUB} {HPL.SELECTORS_UTUB_NAME}",
    )
