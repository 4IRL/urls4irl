...
def get_all_utub_ids_accessible_by_user(app: Flask, user_id: int) -> list[int]:
    """
    Fetches all UTub IDs that the user has access to.
...
def get_tag_id_by_name(app: Flask, utub_id: int, tag_string: str) -> int | None:
    """
