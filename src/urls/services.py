...
from src.urls.forms import NewURLForm, UpdateURLForm
...
def check_for_empty_url_string_on_update(
    url_string: str,
    utub_url_id: int,
) -> tuple[Response, int] | None:
    """
...
def check_for_equivalent_url_on_update(
...
def associate_updated_url_with_utub(
    url: Urls,
    current_utub: Utubs,
