...
| **Service**      | `backend/metrics/query_service.py:grouped_counts` (fanned out per step + per drop_breakdown); `backend/metrics/flows.py:FLOWS` registry + `FlowDefinition`/`FlowStep`/`FlowStepBreakdown`/`FlowId`/`FlowFilterCondition`                                                                                                                                                                |
