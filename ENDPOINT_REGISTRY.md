...
| **JS Module**      | `frontend/lib/metrics-client.ts` (batches UI events, POSTs to `/api/metrics`. Consumes the generated `MetricsIngestRequest` / `MetricsIngestEvent` types from `frontend/types/api.d.ts`.)                                                                                                                                                                                                   |
