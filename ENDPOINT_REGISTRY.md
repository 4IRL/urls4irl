...
| **Schema** | `backend/schemas/requests/urls/create_url.py:CreateURLRequest`, response: `UrlCreatedResponseSchema` embeds `UrlCreatedItemSchema` (distinct subclass of `UtubUrlDeleteSchema`) |
