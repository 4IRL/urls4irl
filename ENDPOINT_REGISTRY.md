...
### GET /api/metrics/query/gauges/latest

| Layer            | Location                                                                                                                                                                                                                                                                                       |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Handler**      | `backend/metrics/routes.py:query_gauges_latest` (operationId `queryGaugesLatest`)                                                                                                                                                                                                              |
| **Decorators**   | `@admin_required`, `@api_route(response_schema=GaugesLatestResponseSchema, tags=[OPEN_API.METRICS], ajax_required=True, description="...", status_codes={200: GaugesLatestResponseSchema, 401: ErrorResponse, 404: ErrorResponse})` (no `query_schema`)                                       |
| **Service**      | `backend/metrics/query_service.py:latest_gauge_snapshot` (DISTINCT ON newest row per gauge)                                                                                                                                                                                                    |
| **Request**      | None — takes no query params                                                                                                                                                                                                                                                                   |
| **Query Params** | None                                                                                                                                                                                                                                                                                           |
| **Response**     | `backend/schemas/metrics.py:GaugesLatestResponseSchema` (`gauges: list[GaugeLatestRow]`)                                                                                                                                                                                                       |
| **CSRF**         | None — GETs not CSRF-checked by Flask-WTF default                                                                                                                                                                                                                                              |
| **Auth**         | `@admin_required` — `User_Role.ADMIN`; 401 anonymous, 404 non-admin                                                                                                                                                                                                                            |
| **CLI**          | `backend/cli/metrics.py:gauges_latest_command` (`flask metrics gauges-latest`)                                                                                                                                                                                                                 |
| **Tests**        | `tests/integration/system/test_metrics_query_endpoints.py` (marker: `cli`), `tests/integration/system/test_metrics_query_cli.py` (marker: `cli`)                                                                                                                                               |

### GET /api/metrics/query/gauges/list

| Layer            | Location                                                                                                                                                                                                                                                                          |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Handler**      | `backend/metrics/routes.py:query_gauges_list` (operationId `queryGaugesList`)                                                                                                                                                                                                     |
| **Decorators**   | `@admin_required`, `@api_route(response_schema=GaugesListResponseSchema, tags=[OPEN_API.METRICS], ajax_required=True, description="...", status_codes={200: GaugesListResponseSchema, 401: ErrorResponse, 404: ErrorResponse})` (no `query_schema`)                               |
| **Service**      | `backend/metrics/query_service.py:list_gauges` (pure `GAUGE_REGISTRY` walk; no DB)                                                                                                                                                                                                |
| **Request**      | None — takes no query params                                                                                                                                                                                                                                                      |
| **Query Params** | None                                                                                                                                                                                                                                                                              |
| **Response**     | `backend/schemas/metrics.py:GaugesListResponseSchema` (`gauges: list[GaugeMetadataRow]`)                                                                                                                                                                                          |
| **CSRF**         | None — GETs not CSRF-checked by Flask-WTF default                                                                                                                                                                                                                                 |
| **Auth**         | `@admin_required` — `User_Role.ADMIN`; 401 anonymous, 404 non-admin                                                                                                                                                                                                               |
| **CLI**          | `backend/cli/metrics.py:gauges_list_command` (`flask metrics gauges-list`)                                                                                                                                                                                                        |
| **Tests**        | `tests/integration/system/test_metrics_query_endpoints.py` (marker: `cli`), `tests/integration/system/test_metrics_query_cli.py` (marker: `cli`)                                                                                                                                  |
