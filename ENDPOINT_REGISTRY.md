...
| **Request**        | `backend/schemas/requests/metrics.py:MetricsIngestRequest` (top-level batch + optional `batch_id`; `csrf_token` field is deprecated and ignored server-side as of 2026-05-17; kept for one-release canary backward compatibility); per-event shape: `MetricsIngestEvent`                                                                                                                    |
