...
| **Dimensions**     | All UI-category events include auto-injected device_type: "mobile" \| "desktop" (matchMedia-detected, TABLET_WIDTH=992 breakpoint). Per-event additional dimensions are defined in backend/metrics/dimension_models.py::DIMENSION_MODELS.                                                                                                                                                   |
