...
| **Decorators** | `@metrics_admin_required`, `@api_route(query_schema=TopEventsQuerySchema, response_schema=TopEventsResponseSchema, tags=[OPEN_API.METRICS], ajax_required=True, description="...", status_codes={200: TopEventsResponseSchema, 400: ErrorResponse, 401: ErrorResponse, 404: ErrorResponse})`                                                                                                                                                                                                                                                            |
...
| **Auth**       | `@metrics_admin_required` — `User_Role.ADMIN`; 401 anonymous, 404 non-admin                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Tests**      | `tests/integration/system/test_metrics_query_endpoints.py` (marker: `cli`), `tests/integration/system/test_metrics_query_service.py` (marker: `cli`), `tests/integration/system/test_metrics_query_cli.py` (marker: `cli`), `tests/unit/test_metrics_admin_required.py` (marker: `unit`), `tests/unit/test_window_parser.py` (marker: `unit`), `tests/unit/test_metrics_query_schemas.py` (marker: `unit`)                                                                                                            |
...
| **Decorators** | `@metrics_admin_required`, `@api_route(query_schema=TimeseriesQuerySchema, response_schema=TimeseriesResponseSchema, tags=[OPEN_API.METRICS], ajax_required=True, description="...", status_codes={200: TimeseriesResponseSchema, 400: ErrorResponse, 401: ErrorResponse, 404: ErrorResponse})`                                                                                                                                                                                                                                                             |
...
| **Decorators** | `@metrics_admin_required`, `@api_route(query_schema=SummaryQuerySchema, response_schema=SummaryResponseSchema, tags=[OPEN_API.METRICS], ajax_required=True, description="...", status_codes={200: SummaryResponseSchema, 400: ErrorResponse, 401: ErrorResponse, 404: ErrorResponse})`                                                                                                                                                                                                                                                             |
