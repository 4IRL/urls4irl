...
class EventName(StrEnum):
    ...
    UI_TAG_SEARCH_OPEN = "ui_tag_search_open"
    UI_TAG_SEARCH_CLOSE = "ui_tag_search_close"
    UI_MEMBER_SEARCH_OPEN = "ui_member_search_open"
    UI_MEMBER_SEARCH_CLOSE = "ui_member_search_close"
    # — Tags
