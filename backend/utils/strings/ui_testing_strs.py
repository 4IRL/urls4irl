...
class UI_TEST_STRINGS:
    ...
    # Display tab (Phase 6) — re-exported for UI assertions against the same
    # backend source the template renders.
    ...
    # Danger zone + account-removal modals (Account tab, Phase 4) — re-exported
    # so the Playwright settings_ui tests assert against the same backend source
    # the template renders. Dynamic success/error banner copy stays server-sourced
    # off the response envelope (not here).
    ...
    # Privacy & Data tab — Export my data (Phase 5). Jinja-rendered; re-exported
    # for Python UI assertions (dynamic status/error copy stays JS-bridged).
