...
class UI_TEST_STRINGS:
    ...
    ADMIN_MOD_UTUB_DELETE_CONFIRM_TITLE = (
        ADMIN_PORTAL_STRINGS.MOD_UTUB_DELETE_CONFIRM_TITLE
    )
    ADMIN_MOD_MEMBER_REMOVE_CONFIRM_TITLE = (
        ADMIN_PORTAL_STRINGS.MOD_MEMBER_REMOVE_CONFIRM_TITLE
    )
    ADMIN_MOD_URL_DELETE_CONFIRM_TITLE = (
        ADMIN_PORTAL_STRINGS.MOD_URL_DELETE_CONFIRM_TITLE
    )
