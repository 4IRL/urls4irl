...
class UI_TEST_STRINGS:
    ...
    ADMIN_MOD_URL_TAG_REMOVE_LABEL = ADMIN_PORTAL_STRINGS.MOD_URL_TAG_REMOVE_LABEL
    ADMIN_MOD_URL_TAG_REMOVE_CONFIRM_TITLE = (
        ADMIN_PORTAL_STRINGS.MOD_URL_TAG_REMOVE_CONFIRM_TITLE
    )
