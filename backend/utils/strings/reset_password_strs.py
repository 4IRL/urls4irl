from backend.utils.strings.email_validation_strs import EXPIRATION
from backend.utils.strings.form_strs import GENERAL_FORM
from backend.utils.strings.splash_form_strs import EMAIL_TEXT
from backend.utils.strings.user_strs import INVALID_EMAIL
