...
CHANGE_EMAIL_SUBJECT = "Confirm your new URLS4IRL email address"
PASSWORD_RESET_SUBJECT = "URLS4IRL Password Reset"
OAUTH_HINT_SUBJECT = "URLS4IRL Sign-In Help"
...
class EMAILS:
    ...
    CHANGE_EMAIL_SUBJECT = CHANGE_EMAIL_SUBJECT
    SANDBOXMODE = SANDBOXMODE
    ...
    OAUTH_HINT_SUBJECT = OAUTH_HINT_SUBJECT
